...
var (
	...
	ErrInvalidSkillOverwrite       = errors.New("invalid skill overwrite selection")
	ErrInvalidAgentsPath           = errors.New("invalid AGENTS.md path")
	ErrInvalidAgentsSelection      = errors.New("invalid AGENTS.md selection")
	ErrInvalidAgentsOverwrite      = errors.New("invalid AGENTS.md overwrite selection")
	ErrInvalidClaudeSelection      = errors.New("invalid CLAUDE.md selection")
	ErrInvalidClaudeOverwrite      = errors.New("invalid CLAUDE.md overwrite selection")
	...
	ErrDeployCompletedWithFailures = errors.New("deploy completed with failures")
)
